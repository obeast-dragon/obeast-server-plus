 ...
 */
#ifndef __OBEAST_ADDRESS_H__
#define __OBEAST_ADDRESS_H__
...
public:
     ...
     * @param[in] host 域名,服务器名等.举例: www.obeast.top[:80] (方括号为可选内容)
...
public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.obeast.top
     * @param[in] port 端口号
