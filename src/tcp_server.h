 ...
 */
#ifndef __OBEAST_TCP_SERVER_H__
#define __OBEAST_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(obeast::IOManager* io_woker = obeast::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(obeast::Address::ptr addr);
